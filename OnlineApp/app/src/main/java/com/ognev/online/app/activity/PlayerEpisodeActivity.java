...
public class PlayerEpisodeActivity extends BaseActivity implements SurfaceHolder.Callback, View.OnClickListener,
...
//  private Button retryButton;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    episode = Parcels.unwrap(getIntent().getParcelableExtra(Constants.EPISODE));
...
//    textButton = (Button) findViewById(R.id.text_controls);
    ...
    if (!TextUtils.isEmpty(episode.url))
      startPlayingVideo(episode.url);

  }


  private void startPlayingVideo(String url) {
