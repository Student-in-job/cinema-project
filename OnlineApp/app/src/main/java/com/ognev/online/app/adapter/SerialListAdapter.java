...
public class SerialListAdapter extends RecyclerView.Adapter<SerialListAdapter.ViewHolder> {
  ...
  public SerialListAdapter(Context context, List<BaseVideo> list) {
  ...
  public void onBindViewHolder(ViewHolder holder, final int position) {
    ...
    holder.itemView.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        context.startActivity(new Intent(context, SerialActivity.class)
            .putExtra(Constants.SERIAL, Parcels.wrap(list.get(position))));
      }
    });
  }
