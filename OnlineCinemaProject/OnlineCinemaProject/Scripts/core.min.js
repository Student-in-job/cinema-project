...
function widthFunctions(e) {
    ...
    var t = $("#sidebar-left").outerHeight(),
        ...
        u < 768 ? $(".chat-full") && $(".chat-full").each(
            function() {
                 $(this).addClass("alt")
            }) : $(".chat-full") && $(".chat-full").each(
            function() {
...
jQuery(document).ready(
    function(e) {
        ...
        e("#toggle-fullscreen").button().click(
            function() {
                var t = e(this),
        ...
        e(".btn-minimize").click(
            function(t) {
                ...
                n.is(":visible") ?
                e("i", e(this)).removeClass("fa fa-chevron-up").addClass("fa fa-chevron-down") :
                e("i", e(this)).removeClass("fa fa-chevron-down").addClass("fa fa-chevron-up");
                n.slideToggle("slow", function () { widthFunctions() })
            });
        e(".btn-add").click(
            function(t) {
                 t.preventDefault(); e("#addTariff").modal("show")
            })
    });
jQuery(document).ready(
    function(e) {
        e(".discussions").find(".delete").click(
            function() {
...
jQuery(document).ready(
    function (e) {
        e("ul.main-menu li a").each(
            function() {
                 e(e(this))[0].href == String(window.location) && e(this).parent().addClass("active")
            });
        e("ul.main-menu li ul li a").each(
            function() {
                 if (e(e(this))[0].href == String(window.location)) {
                      e(this).parent().addClass("active"); e(this).parent().parent().show()
                 }
            });
        e(".dropmenu").click(
            function(t) {
...
jQuery(document).ready(
    function(e) {
         ...
         e(".chart-stat").length && (retina() ? e(".chart-stat > .chart").each(
             function() {
