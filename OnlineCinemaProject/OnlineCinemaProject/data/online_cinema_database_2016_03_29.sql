...
CREATE TABLE `subscriptions` (
  ...
  KEY `FkUserSubscription_idx` (`UserId`),
  CONSTRAINT `FkPaymentSubscription` FOREIGN KEY (`payment_id`) REFERENCES `payments` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FkUserSubscription` FOREIGN KEY (`UserId`) REFERENCES `aspnetusers` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `subscriptions` VALUES (1,1,'2016-03-12','2016-03-12',10000,'ac1da694-6aee-4080-8c69-cac3342baada'),(2,1,'2016-03-16','2016-04-16',4,'ac1da694-6aee-4080-8c69-cac3342baada');
...
-- Dump completed on 2016-03-29 10:31:39
