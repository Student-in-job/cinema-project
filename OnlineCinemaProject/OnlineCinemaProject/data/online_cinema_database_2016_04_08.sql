...
--
-- Host: localhost    Database: online-cinema
-- ------------------------------------------------------
...
INSERT INTO `advertiser` VALUES (1,'cocacola','coca@mail.ru','+998935718543'),(3,'M&Ms','mandms@mail.ru','+998935718545'),(4,'Alpen Gold','gold@inbox.ru','+998979999999'),(5,'sarkor','support@sarkor.uz','+998711220000'),(6,'кинотеатр','cinema@mail.ru','+999999999999');
...
INSERT INTO `aspnetuserroles` VALUES ('ac1da694-6aee-4080-8c69-cac3342baada','1a6d70ef-2b86-48da-b36c-b974855a8783'),('ac1da694-6aee-4080-8c69-cac3342baada','4d5f7e37-2498-40db-9891-ea998b599671'),('ac1da694-6aee-4080-8c69-cac3342baada','4de2ec91-cce0-46e3-8723-cbea20461ef4'),('ac1da694-6aee-4080-8c69-cac3342baada','6fc8922c-be46-445f-aa95-d3b7a7fd9145'),('891d17ed-78f3-4809-a4cc-3c16d6b552d9','92b3e227-35be-413e-a9e3-3e82d944a256'),('ac1da694-6aee-4080-8c69-cac3342baada','92b3e227-35be-413e-a9e3-3e82d944a256'),('c7f12ba4-a5dc-4523-9f9d-2e65f1115d4b','92b3e227-35be-413e-a9e3-3e82d944a256'),('f47c353c-364b-4552-b903-b1b5a550401e','92b3e227-35be-413e-a9e3-3e82d944a256');
...
INSERT INTO `aspnetusers` VALUES ('891d17ed-78f3-4809-a4cc-3c16d6b552d9','SimpleUser1','APXu8gRtVUS5yBlX7dGG5WffjoC3lMEyq2TcwoEry+fb0REdxorZohdjUDLFmPXLvg==','03adbff0-eacd-4098-9f91-9971be96615f','ApplicationUser','SimpleUserFirstName_1','SimpleUserLastName_2','1994-06-21','ramazan.333a@gmail.com',0,'2016-04-05 00:00:00',10000,NULL),('ac1da694-6aee-4080-8c69-cac3342baada','ramazan','AL1eBAAgCiB+MY8RWKKrFo0ROvR5PtTGgSy8u0htKRtLID2bSxCCWekV4/d41FZM7Q==','d2f47bf0-bfbe-4e94-8b6e-ffd0bf3b23a5','ApplicationUser','Ramazan','Ariskaliev','2016-03-12','ramazan.333a@gmail.com',1,'2016-03-12 00:00:00',0,1),('f47c353c-364b-4552-b903-b1b5a550401e','SimpleUser','AMmHNe+fRUagVjKRHu3IosMCU0xQfHbu4s3mHzNsXrmJwc1S0SWfktGgaZZxFA/jOQ==','81cc66a9-b1af-4567-9fbd-cb5cce418bed','ApplicationUser','SimpleUserFirstName_0','SimpleUserLastName_0','1995-04-08','ramazan.333a@gmail.com',1,'2016-04-05 00:00:00',5000,1);
...
CREATE TABLE `banners` (
  ...
  `show_amount` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
INSERT INTO `banners` VALUES (3,'2016-03-11','2016-03-15',18000,4,'banner0001','images (3).jpg',26),(4,'2016-03-30','2016-03-31',15000,3,'banner0002','app.jpg',26),(5,'2016-03-10','2016-03-13',12000,1,'banner0003','1523.jpg',26),(6,'2016-03-12','2016-03-13',12500,5,'banner0004','uyvhbjnk.jpg',26),(7,'2016-03-29','2016-04-08',0,6,'cinema banner','images25.jpg',26);
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=8192 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `moviehistory` VALUES (23,'891d17ed-78f3-4809-a4cc-3c16d6b552d9',4,'2016-04-07 16:05:32'),(24,'891d17ed-78f3-4809-a4cc-3c16d6b552d9',4,'2016-04-07 16:18:18');
...
INSERT INTO `movies` VALUES (4,'http://172.20.16.4/mobile/panda/panda.m3u8','2016-02-29',17,10000.00,1),(5,'http://172.20.16.4/mobile/pursuit/pursuit_of_happYness.m3u8','2016-02-29',18,8000.00,0),(6,'http://172.20.16.4/mobile/words/words.m3u8','2016-02-29',19,10000.00,0),(7,'http://172.20.16.4/mobile/jane/jane.m3u8','1899-12-30',19,8000.00,0),(8,'http://172.20.16.4/mobile/megamozg/megamind.m3u8','2016-04-01',27,8000.00,1),(9,'http://172.20.16.4/mobile/rapuntzel/rapuntel.m3u8','1899-12-01',28,10000.00,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=1489 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `payments` VALUES (12,'Пополнение баланса','2016-04-05 00:00:00',20000,'891d17ed-78f3-4809-a4cc-3c16d6b552d9',1),(13,'Пополнение баланса','2016-04-05 22:12:29',15000,'f47c353c-364b-4552-b903-b1b5a550401e',1),(14,'Покупка фильма Боги Египта','2016-04-06 05:22:11',10000,'891d17ed-78f3-4809-a4cc-3c16d6b552d9',0),(15,'Подписка на тариф base','2016-04-06 05:59:40',10000,'f47c353c-364b-4552-b903-b1b5a550401e',0);
...
--
-- Table structure for table `statistics_banner`
--

DROP TABLE IF EXISTS `statistics_banner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `statistics_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=2340 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `statistics_banner` WRITE;
/*!40000 ALTER TABLE `statistics_banner` DISABLE KEYS */;
INSERT INTO `statistics_banner` VALUES (8,'2016-04-07',25,3,'891d17ed-78f3-4809-a4cc-3c16d6b552d9'),(9,'2016-04-07',25,4,'891d17ed-78f3-4809-a4cc-3c16d6b552d9'),(10,'2016-04-07',25,5,'891d17ed-78f3-4809-a4cc-3c16d6b552d9'),(11,'2016-04-07',25,6,'891d17ed-78f3-4809-a4cc-3c16d6b552d9'),(12,'2016-04-07',25,7,'891d17ed-78f3-4809-a4cc-3c16d6b552d9'),(13,'2016-04-07',26,3,'891d17ed-78f3-4809-a4cc-3c16d6b552d9'),(14,'2016-04-07',26,4,'891d17ed-78f3-4809-a4cc-3c16d6b552d9'),(15,'2016-04-07',26,5,'891d17ed-78f3-4809-a4cc-3c16d6b552d9'),(16,'2016-04-07',26,6,'891d17ed-78f3-4809-a4cc-3c16d6b552d9'),(17,'2016-04-07',26,7,'891d17ed-78f3-4809-a4cc-3c16d6b552d9');
/*!40000 ALTER TABLE `statistics_banner` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `statistics_teaser`
--

DROP TABLE IF EXISTS `statistics_teaser`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `statistics_teaser` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `statistics_teaser` WRITE;
...
INSERT INTO `subscriptions` VALUES (1,1,'2016-04-06 05:59:41','2016-05-06 05:59:41',15,'f47c353c-364b-4552-b903-b1b5a550401e');
...
INSERT INTO `teaser` VALUES (3,'2016-03-31','2016-04-02',9,20000,4,'teaser0001','ca878584ed6edaa80707c29609e66a20.gif'),(4,'2016-03-31','2016-04-02',9,18000,1,'teaser0002','embarcadero_190x280_till25_5494326.jpg'),(5,'2016-03-31','2016-04-01',9,15000,1,'teaser0001','130309.gif'),(6,'2016-03-31','2016-04-01',8,5000,1,'teaser0002','140104.gif');
...
INSERT INTO `usermovies` VALUES (1,'891d17ed-78f3-4809-a4cc-3c16d6b552d9',4,14);
...
-- Dump completed on 2016-04-08 19:29:48
